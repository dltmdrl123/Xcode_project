...
class map6ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let initialLocation = CLLocationCoordinate2D(latitude: 37.5352, longitude: 127.1374
)
        ...
        annotation1.coordinate = CLLocationCoordinate2D(latitude: 37.5352, longitude: 127.1374)
        annotation1.title = "우리콩순두부"
