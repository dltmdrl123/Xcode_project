...
class map4ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let initialLocation = CLLocationCoordinate2D(latitude: 37.5097, longitude: 127.0807
)
        ...
        annotation1.coordinate = CLLocationCoordinate2D(latitude: 37.5097, longitude: 127.0807)
        annotation1.title = "홀짝집"
