...
class map5ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let initialLocation = CLLocationCoordinate2D(latitude: 37.537, longitude: 127.1388
)
        ...
        annotation1.coordinate = CLLocationCoordinate2D(latitude: 37.537, longitude: 127.1388)
        annotation1.title = "대관령생고기"
